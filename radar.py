...
# --- 1. KONFIGURACIJA ---
st.set_page_config(page_title="Wolt BI Radar v25.2", layout="wide", page_icon="📡")
...
# --- 2. JS KOMPONENTA ZA SMOOTH TAJMER ---
...
with tab1:
    st.subheader(f"📍 Stanje u gradu: {grad_naziv} ({filter_status})")
...
with tab4:
    st.subheader("Cloud Service (Samo aktivni)")
